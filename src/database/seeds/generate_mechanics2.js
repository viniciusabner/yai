...
const cityId = 'bb65710d-7049-43c7-9519-72fd7a2d6771';
...
const jsonResult = mechanics.map(mech => {
  return {
    ...
    whatsapp: mech.phone,
    phone: mech.phone,
    email: sluggify(mech.name) + '@gmail.com',
    source: 'manual_google',
    active: true,
    created_at: new Date('2026-01-05T12:00:00Z').toISOString(),
    slug: sluggify(mech.name) + '-' + citySlug,
    category: 'mecanica',
...
fs.writeFileSync('c:/Users/Vida/Documents/yai/src/database/seeds/130_real_mechanics_santo_andre.json', JSON.stringify(jsonResult, null, 2));
...
const sqlContent = "-- Seed para Mecânicas Gerais reais em Santo André, SP\\nINSERT INTO public.providers (id, name, city_id, neighborhood, address, whatsapp, phone, email, source, active, slug, category, website, city_slug, state)\\nVALUES \\n  " + sqlInsert + "\\nON CONFLICT (id) DO NOTHING;";

fs.writeFileSync('c:/Users/Vida/Documents/yai/src/database/seeds/130_real_mechanics_santo_andre.sql', sqlContent);

console.log('Successfully wrote JSON and SQL files for ' + mechanics.length + ' mechanics.');
