...
const sqlFile = "-- Seed para Mecânicas Gerais reais em Santo André, SP\\nINSERT INTO public.providers (id, name, city_id, neighborhood, address, whatsapp, phone, email, source, active, slug, category, website, city_slug, state)\\nVALUES \\n  " + sqlInsert + "\\nON CONFLICT (id) DO NOTHING;";

fs.writeFileSync('c:/Users/Vida/Documents/yai/src/database/seeds/130_real_mechanics_santo_andre.sql', sqlFile);
